#Used this file from https://github.com/lc0197/emotion_modelling_stories/tree/main
...
#SHB: to_remove_df code lines commented out, no such csv provided in the repo
